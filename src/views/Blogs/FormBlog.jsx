...
class FormBlog extends Component {
  ...
  componentWillReceiveProps = (props) => {
    const { blog } = props;
    if (blog && blog !== {}) {
      const contentState = ContentState.createFromBlockArray(htmlToDraft(blog.content || ''));
  ...
  render() {
    ...
    return (
      ...
      <Form autoComplete="off" onSubmit={this.handleSubmit} className="was-validated">
        ...
        <FormGroup>
          <InputGroup>
            <Input required type="text" name="name" placeholder="Title" onChange={this.handleChange} value={this.state.name} autoComplete="off" />
