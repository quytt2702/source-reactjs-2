      ...
      <Form autoComplete="off" onSubmit={this.handleSubmit}>
        ...
        <FormGroup>
          <InputGroup>
            ...
            <Input type="text" name="name" placeholder="Name" onChange={this.handleChange} value={this.state.name} autoComplete="off" />
          </InputGroup>
        </FormGroup>
        <Label htmlFor="prependedInput"><h5>Select Type of Salon</h5></Label>
        <FormGroup>
        <Select value={this.state.selectedType} name="type" onChange={this.onChangeType} options={this.state.types} />
        </FormGroup>
        <FormGroup>
          <InputGroup>
            <InputGroupAddon addonType="append">
        ...
        <FormGroup>
          <InputGroup>
            ...
            <Input type="text" name="location" placeholder="City" onChange={this.handleChange} value={this.state.location} autoComplete="off" />
          </InputGroup>
        </FormGroup>
        <FormGroup>
          <Editor
        ...
        <FormGroup>
          <Select value={this.state.selectedOption} name="owners" isMulti onChange={this.onChangeOwner} options={this.state.users} />
        </FormGroup>
              ...
              <Row key={i}>
                ...
                <Col xs="4">
                  <FormGroup>
                    ...
                    <div><TimePicker value={new Date(1995, 6, 30, time.begin_time)} onChange={this[`onChangeBeginTime_${i}`]} /></div>
                  </FormGroup>
                </Col>
                <Col xs="4">
                  <FormGroup>
                    {i === 0 && <Label htmlFor="ccmonth">END TIME</Label>}
                    <div><TimePicker value={new Date(1995, 6, 30, time.end_time)} onChange={this[`onChangeEndTime_${i}`]} /></div>
                  </FormGroup>
                </Col>
              </Row>
            )
